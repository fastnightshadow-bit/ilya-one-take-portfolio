...
Публикация на GitHub Pages выполняется автоматически из ветки `main` после прохождения тестов, сборки и проверки SEO. Публичный адрес:
...
Canonical URL, Open Graph, Twitter Card, JSON-LD и sitemap настроены на публичный GitHub Pages-адрес. При переносе на собственный домен эти URL нужно заменить вместе и затем снова выполнить `npm run check`.
